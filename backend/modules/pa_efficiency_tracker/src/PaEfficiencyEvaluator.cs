...
using PaEfficiencyTracker.Module.Models.Events;
using PaEfficiencyTracker.Module.Repositories;
...
public class PaEfficiencyEvaluator : IPaEfficiencyEvaluator
{
    ...
    public double CalibrateTemperature(
        double rawTemperature,
    ...
    public static double EstimateDcCurrent(double outputPowerW, double temperature)
    {
    ...
    public static double CalculateTemperatureDerating(double temperature)
    {
    ...
    public static double CalculateEfficiencyDecayRate(double[] efficiencyHistory)
    {
    ...
    public double PredictRemainingLifetime(
        double currentEfficiency,
        double decayRate,
        double temperature)
    {
    ...
    public string GenerateReplacementReason(
